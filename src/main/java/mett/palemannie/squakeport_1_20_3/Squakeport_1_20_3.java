...
@Mod(Squakeport_1_20_3.MODID)
public class Squakeport_1_20_3
{
    public static final String MODID = "squakeport_1_20_3";
    public static final String MODNAME = "Squakeport_1_20_3";
    public static Squakeport_1_20_3 instance;
    public static final Logger LOGGER = LogManager.getLogger(MODNAME);

    public Squakeport_1_20_3()
    {
