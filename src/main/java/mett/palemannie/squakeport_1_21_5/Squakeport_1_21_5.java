...
@Mod(Squakeport_1_21_5.MODID)
public class Squakeport_1_21_5
{
    public static final String MODID = "squakeport_1_21_5";
    public static final String MODNAME = "Squakeport_1_21_5";
    public static Squakeport_1_21_5 instance;
    public static final Logger LOGGER = LogManager.getLogger(MODNAME);

    public Squakeport_1_21_5()
    {
